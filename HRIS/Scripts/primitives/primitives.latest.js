...
/* File: /common/init.js*/
/**
 * @preserve Basic Primitives Diagram v3.1.2
...
primitives.famdiagram.Control = function (element, options) {
	...
	function createTaskManager(getOptions, getGraphics, getLayout) {
		...
		tasks.addTask('ShapeAnnotationOptionTask', ['SplitAnnotationsOptionTask', 'defaultShapeAnnotationConfig'], primitives.orgdiagram.ShapeAnnotationOptionTask, "#000080"/*primitives.common.Colors.Navy*/);
		...
		tasks.addTask('ConnectorAnnotationOptionTask', ['SplitAnnotationsOptionTask', 'defaultConnectorAnnotationConfig'], primitives.orgdiagram.ConnectorAnnotationOptionTask, "#000080"/*primitives.common.Colors.Navy*/);
		...
		tasks.addTask('NormalVisibilityItemsByShapeAnnotationTask', ['ShapeAnnotationOptionTask'], primitives.orgdiagram.NormalVisibilityItemsByAnnotationTask, "#00ffff"/*primitives.common.Colors.Cyan*/);
		...
		tasks.addTask('NormalVisibilityItemsByConnectorAnnotationTask', ['ConnectorAnnotationOptionTask'], primitives.orgdiagram.NormalVisibilityItemsByConnectorAnnotationTask, "#00ffff"/*primitives.common.Colors.Cyan*/);
		tasks.addTask('CombinedNormalVisibilityItemsTask', [
			...
			'NormalVisibilityItemsByShapeAnnotationTask',
			'NormalVisibilityItemsByBackgroundAnnotationTask',
			'NormalVisibilityItemsByHighlightPathAnnotationTask',
			'NormalVisibilityItemsByConnectorAnnotationTask'], primitives.orgdiagram.CombinedNormalVisibilityItemsTask, "#00ffff"/*primitives.common.Colors.Cyan*/);
		...
		tasks.addTask('DrawConnectorAnnotationTask', ['graphics', 'CreateTransformTask', 'ApplyLayoutChangesTask', 'OrientationOptionTask', 'ConnectorAnnotationOptionTask', 'AlignDiagramTask'], primitives.orgdiagram.DrawConnectorAnnotationTask, "#008000"/*primitives.common.Colors.Green*/);
		tasks.addTask('DrawShapeAnnotationTask', ['graphics', 'CreateTransformTask', 'ApplyLayoutChangesTask', 'OrientationOptionTask', 'ShapeAnnotationOptionTask', 'AlignDiagramTask'], primitives.orgdiagram.DrawShapeAnnotationTask, "#008000"/*primitives.common.Colors.Green*/);
		...
		tasks.addTask('DrawPrintPreviewTask', ['graphics', 'ApplyLayoutChangesTask', 'PrintPreviewOptionTask', 'AlignDiagramTask', 'ScaleOptionTask'], primitives.orgdiagram.DrawPrintPreviewTask, "#008000"/*primitives.common.Colors.Green*/);
	...
	function createEventArgs(data, oldTreeItemId, newTreeItemId, name) {
		...
		if (newItemConfig && newItemConfig.id != null) {
			...
			result.position = new primitives.common.Rect(alignDiagramTask.getItemPosition(newTreeItemId))
...
/* File: /Controls/OrgDiagram/Models/LabelTemplate.js*/
primitives.orgdiagram.Template = function (options, templateConfig) {
	this.templateConfig = templateConfig;

	this.minimizedItemCornerRadius = templateConfig.minimizedItemCornerRadius === null ?
		templateConfig.minimizedItemSize.width / 2.0 :
		templateConfig.minimizedItemCornerRadius;
...
primitives.orgdiagram.AlignDiagramTask = function (orientationOptionTask, itemsSizesOptionTask, visualTreeOptionTask, scaleOptionTask, printPreviewOptionTask,
	...
	function getNextLevelTreeItem(fromTreeItem, isBelow) {
		...
		_treeLevels.loopLevelsFromItem(this, fromTreeItem, isBelow, function (levelIndex) {
			_treeLevels.loopLevelItems(this, levelIndex, function (itemid, item) {
				var treeItemPosition = _data.treeItemsPositions[itemid];
		...
		return _visualTree.node(bestTreeItemId);
	}

	function getNextTreeItem(fromTreeItem, isLeft) {
		var result = fromTreeItem.id,
			treeItemPosition;
		_treeLevels.loopFromItem(this, fromTreeItem, isLeft, function (treeItemId) {
		...
		return _visualTree.node(result);
	}
...
primitives.orgdiagram.BackgroundAnnotationOptionTask = function (splitAnnotationsOptionTask, defaultBackgroundAnnotationConfig) {
	...
	function process() {
		...
		_annotations = _dataTemplate.read(_annotations, splitAnnotationsOptionTask.getAnnotations(4/*primitives.common.AnnotationType.Background*/), "annotations", context);
...
primitives.orgdiagram.ConnectorAnnotationOptionTask = function (splitAnnotationsOptionTask, defaultConnectorAnnotationConfig) {
	var _annotations = [],
		_hash = {};
	...
	function process() {
		...
		_annotations = _dataTemplate.read(_annotations, splitAnnotationsOptionTask.getAnnotations(0/*primitives.common.AnnotationType.Connector*/), "annotations", context);
...
primitives.orgdiagram.HighlightPathAnnotationOptionTask = function (splitAnnotationsOptionTask, defaultConfig, defaultHighlightPathAnnotationConfig) {
	...
	function process() {
		...
		_data = _dataTemplate.read(_data, splitAnnotationsOptionTask.getAnnotations(2/*primitives.common.AnnotationType.HighlightPath*/), "options", context);
		_annotations = _dataAnnotationsTemplate.read(_annotations, splitAnnotationsOptionTask.getAnnotations(2/*primitives.common.AnnotationType.HighlightPath*/), "annotations", context);
...
primitives.orgdiagram.ShapeAnnotationOptionTask = function (splitAnnotationsOptionTask, defaultShapeAnnotationConfig) {
	var _annotations = [],
		_hash = {};
	...
	function process() {
		...
		_annotations = _dataTemplate.read(_annotations, splitAnnotationsOptionTask.getAnnotations(1/*primitives.common.AnnotationType.Shape*/), "annotations", context);
...
primitives.orgdiagram.SplitAnnotationsOptionTask = function (optionsTask) {
		...
		if (Array.isArray(annotations)) {
			for (index = 0, len = annotations.length; index < len; index += 1) {
				...
				if (annotationType != null) {
					if (hash.hasOwnProperty(annotationType)) {
						hash[annotationType].push(annotationConfig);
					} else {
						hash[annotationType] = [annotationConfig];
					}
				}
			}
		}
	...
	function getAnnotations(annotationType) {
		return _data.annotations[annotationType];
	}
...
primitives.orgdiagram.DrawConnectorAnnotationTask = function (getGraphics, createTranfromTask, applyLayoutChangesTask,
	orientationOptionTask, connectorAnnotationOptionTask, alignDiagramTask) {
	var _graphics,
		_transform,
		_orientationOptions,
		_annotationLabelTemplate = new primitives.common.AnnotationLabelTemplate();
		...
		for (index = 0, len = annotations.length; index < len; index += 1) {
			...
			if (annotationConfig.fromItem != null && annotationConfig.toItem != null) {
				...
				if (fromItemPosition != null && toItemPosition != null) {
					...
					shape = new primitives.common.Connector(_graphics);
					...
					switch (shape.zOrderType) {
						case 1/*primitives.common.ZOrderType.Background*/://ignore jslint
							layer = 4/*primitives.common.Layers.BackgroundConnectorAnnotation*/;
							break;
					...
					panel = _graphics.activate("placeholder", layer);
					shape.panelSize = panel.size;

					_transform.transformRect(fromActualPosition.x, fromActualPosition.y, fromActualPosition.width, fromActualPosition.height, true,
						this, function (x, y, width, height) {
							var fromRect = new primitives.common.Rect(x, y, width, height);
							_transform.transformRect(toActualPosition.x, toActualPosition.y, toActualPosition.width, toActualPosition.height, true,
								this, function (x, y, width, height) {
...
primitives.orgdiagram.DrawPrintPreviewTask = function (getGraphics, applyLayoutChangesTask,
	printPreviewOptionTask, alignDiagramTask, scaleOptionTask) {
	var _graphics;
	...
	function drawPrintPreview(options, scaleOptions) {
		var panel,
			...
			element,
			panelSize = alignDiagramTask.getContentSize(),
			printPreviewTemplate = new primitives.common.PrintPreviewTemplate(options);
...
primitives.orgdiagram.DrawShapeAnnotationTask = function (getGraphics, createTransformTask, applyLayoutChangesTask,
	orientationOptionTask, shapeAnnotationOptionTask, alignDiagramTask) {
	var _graphics,
		_transform,
		_orientationOptions,
		_annotationLabelTemplate = new primitives.common.AnnotationLabelTemplate();
...
primitives.orgdiagram.CombinedNormalVisibilityItemsTask = function (itemsSizesOptionTask, cursorItemTask, cursorNeighboursTask, selectedItemsTask, selectionPathItemsTask,
	normalVisibilityItemsByShapeAnnotationTask, normalVisibilityItemsByBackgroundAnnotationTask, normalVisibilityItemsByHighlightPathAnnotationTask, normalVisibilityItemsByConnectorAnnotationTask) {
	var _data = {
			items: []
		},
		_hash = {},
		...
		_treeLevels.loopLevels(this, function (levelIndex, treeLevel) {
			...
			if (treeItemsHavingPartners.length > 0) {
				...
				for (index2 = 0, len2 = treeItemsHavingPartners.length; index2 < len2; index2 += 1) {
					...
					var treeItemExtraPartners = extraPartnersTask.getOrgPartners(treeItemsGroup.context.id);
					partners = treeItemsGroup.context.partners.slice(0);
					if (partners.length === 0) {
						partners.push(treeItemsGroup.context.id);
					}
				...
				treeLevelPosition.partnerConnectorOffset = primitives.common.stackSegments(treeItemsHavingPartners, function (item, offset) {
					_data.treeItemsPositions[item.context.id].partnerConnectorOffset = offset;
				});//ignore jslint
			}
		});
	}
...
primitives.orgdiagram.BaseControl = function (element, options, taskManagerFactory, eventArgsFactory) {
	...
	function refresh(forceCenterOnCursor, debug) {
		...
		_data.tasks.process('OptionsTask', debug);
	...
	function positionHighlight(debug) {
		...
		_data.tasks.process('HighlightItemOptionTask', debug);
	...
	function onKeyDown(event) {
		var highlightItemTask = _data.tasks.getTask("HighlightItemTask"),
			...
			currentHilightItem = highlightItemTask.getHighlightTreeItem() || cursorItemTask.getCursorTreeItem(),
			newHilightItem,
			direction = null,
			accepted,
			layout = _data.layout;
		...
		if (currentHilightItem != null) {
			switch (event.which) {
				case 13: /*Enter*/
					setCursorItem(event, currentHilightItem);
					event.preventDefault();
			...
			if (direction != null) {
				...
				while (!accepted) {
					...
					switch (direction) {
						case 0/*primitives.common.OrientationType.Top*/:
							newHilightItem = alignDiagramTask.getNextLevelTreeItem(currentHilightItem, false);
							break;
						case 1/*primitives.common.OrientationType.Bottom*/:
							newHilightItem = alignDiagramTask.getNextLevelTreeItem(currentHilightItem, true);
							break;
						case 2/*primitives.common.OrientationType.Left*/:
							newHilightItem = alignDiagramTask.getNextTreeItem(currentHilightItem, true);
							break;
						case 3/*primitives.common.OrientationType.Right*/:
							newHilightItem = alignDiagramTask.getNextTreeItem(currentHilightItem, false);
							break;
					}
					...
					if (newHilightItem != null) {
						event.preventDefault();
						if (highlightItemOptionTask.hasHighlightEnabled()) {
							setHighlightItem(event, newHilightItem);
						} else if (cursorItemOptionTask.hasCursorEnabled()) {
							setCursorItem(event, newHilightItem);
						}
	...
	function setHighlightItem(event, newHighlightItem) {
		var result = true,
			eventArgs;
		if (newHighlightItem !== null) {
			if (newHighlightItem.id !== _data.options.highlightItem) {
				eventArgs = getEventArgs(_data.options.highlightItem, newHighlightItem.id);

				trigger("onHighlightChanging", event, eventArgs);

				_data.options.highlightItem = newHighlightItem.id;
...
primitives.common.TaskManager = function () {
	...
	function process(startTask, debug) {
			...
			switch(property) {
				...
				case 'onHighlightChanged':
					result[property] = function (event, eventArgs) {
						...
						self._trigger("onHighlightChanged", event, eventArgs);
					};
					break;
				case 'onCursorChanged':
					result[property] = function (event, eventArgs) {
						...
						self._trigger("onCursorChanged", event, eventArgs);
					};
					break;
