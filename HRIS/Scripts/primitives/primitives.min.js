/*
 Basic Primitives Diagram v3.1.2
...
f(b,g,c)}Q=d();e(j.orgTree,b,Q)}}function d(){var a={};j.orgTree.loopPostOrder(this,function(b,c,d){l=null!=l?Math.min(l,c.level):c.level;n=null!=n?Math.max(n,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function e(a,b,c){var d,f,e,g,j,k,h,i,l,n,m;a.loopLevels(this,function(C,x){var L=primitives.common.graph(),E={},G=null,Q;h=[];a.loopChildren(this,x.id,function(c,
e,g){var h;null==G&&(G=e);E[e.id]={};if(b.hasOwnProperty(e.id))for(h in k=b[e.id],k)if(k.hasOwnProperty(h)){n=k[h];E[e.id][h]={};d=0;for(f=n.length;d<f;d+=1)j=n[d],Q=j.commonParent==x.id?j.toParent:a.node(j.fromParent).childIndex<a.node(j.toParent).childIndex?"__right__":"__left__",e.id!=Q&&(L.addEdge(e.id,Q,{weight:0}),L.edge(e.id,Q).weight+=1,null==E[e.id][h][Q]&&(E[e.id][h][Q]=0),E[e.id][h][Q]+=1)}0<g&&L.addEdge(e.id,G.id,{weight:0})});if(null!=G){m=L.getGrowthSequence(function(a){return a.weight});
...
U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U)):(Z.balance-=1,U.balance+=1,P.loop(function(a){if(a.id!=U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U))));P.loop(function(a){a=a.itemId;null!=a&&("__left__"!=a&&"__right__"!=a)&&M.push(a)});i=M;e=0;for(g=i.length;e<g;e+=1)l=a.node(i[e]),l.childIndex=e,h.push(l.id)}a.arrangeChildren(x.id,h)})}function f(a,b,c){var d=new primitives.famdiagram.ExtraGravity(b.level),
...
f.addDependency("defaultLabelAnnotationConfig",new primitives.famdiagram.LabelAnnotationConfig);f.addDependency("isFamilyChartMode",!0);f.addDependency("showElbowDots",!0);f.addDependency("null",null);f.addTask("OptionsTask",["options"],primitives.famdiagram.OptionsTask,"#000000");f.addTask("CurrentControlSizeTask",["layout","OptionsTask","ItemsSizesOptionTask"],primitives.orgdiagram.CurrentControlSizeTask,"#000000");f.addTask("CurrentScrollPositionTask",["layout","OptionsTask"],primitives.orgdiagram.CurrentScrollPositionTask,
...
else if(f.connectorPlacement&1&&!j){V=!0;if(a)switch(p.actualVisibility){case 2:case 3:V=X}H=new primitives.orgdiagram.ConnectorPoint(p.actualPosition.horizontalCenter()+0,p.actualPosition.top());H.isSquared=V;H.connectorStyleType=B.highlightPath?2:1;H.visibility=p.actualVisibility;k.push(H);S=Math.max(S,H.connectorStyleType);N=N||H.isSquared}}),!j&&0<k.length&&(r.transformPoints(T,O,T,e.shift+e.connectorShift,!0,this,function(a,f,e,j){var h=Math.round(s.elbowDotSize/2),i=c.getPalette(S),n=b.getPolyline(i),
n=b.getPolyline(n.arrowPaletteItem);g&&(0!=s.elbowType&&0<d.partners.length)&&n.addSegment(new primitives.common.DotSegment(a-h,f-h,2*h,2*h,h));b.addInverted(function(c){c=c.getPolyline(i);c.addSegment(new primitives.common.MoveSegment(e,j));c.addSegment(new primitives.common.LineSegment(a,f));1==s.arrowsDirection&&(4!=d.visibility&&1>=l.length)&&c.addArrow(s.linesWidth,function(a){a.mergeTo(b.getPolyline(a.paletteItem))})});g&&(0!=s.elbowType&&1<k.length)&&n.addSegment(new primitives.common.DotSegment(e-
h,j-h,2*h,2*h,h))}),t(b,c,T,e.shift+e.connectorShift,k,N,a,2==s.arrowsDirection)))}function m(a,b,c,d,f,e,g,j){a=new primitives.common.Point(a,b);c=new primitives.common.Point(c,d);d=!1;switch(s.arrowsDirection){case 1:4!=j&&(d=!0);break;case 2:4!=g&&(a.swap(c),d=!0)}e.addSegment(new primitives.common.MoveSegment(a));e.addSegment(new primitives.common.LineSegment(c));d&&e.addArrow(s.linesWidth,function(a){a.mergeTo(f.getPolyline(a.paletteItem))})}function t(a,b,c,d,f,e,g,j){var k,h,i,l=[],n,m,v;if(e){l=
[];e=0;for(h=f.length;e<h;e+=1)if(i=f[e],i.x<c&&!i.isSquared)l.push(i);else break;h=l.length;0<h&&q(a,b,c,d,l,!1,j);l=[];for(k=f.length-1;k>=e;k-=1)if(i=f[k],i.x>c&&!i.isSquared)l.push(i);else break;h=l.length;0<h&&q(a,b,c,d,l,!1,j);l={};h={};for(m in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(m)&&(l[primitives.common.ConnectorStyleType[m]]=c,h[primitives.common.ConnectorStyleType[m]]=c);for(m=e;m<=k;m+=1){i=f[m];n=b.getPalette(i.connectorStyleType);v=
a.getPolyline(n);n=s.bevelSize;2>n&&(n=0);if(g)switch(s.elbowType){case 2:case 3:0<n&&(Math.abs(c-i.x)>n&&Math.abs(d-i.y)>n)&&(i.hasElbow=!0,i.elbowPoint1=new primitives.common.Point(i.x,d+(d>i.y?-n:n)),i.elbowPoint2=new primitives.common.Point(i.x+(c>i.x?n:-n),d));break;case 1:0<k-e&&r.transformPoints(i.x,d,i.x,i.y,!0,this,function(b,c){var d=Math.round(s.elbowDotSize/2);a.getPolyline(v.arrowPaletteItem).addSegment(new primitives.common.DotSegment(b-d,c-d,2*d,2*d,d))})}l[i.connectorStyleType]=Math.min(l[i.connectorStyleType],
i.hasElbow?i.elbowPoint2.x:i.x);h[i.connectorStyleType]=Math.max(h[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x)}n=[Math.max(0,e-1),Math.min(k+1,f.length-1)];for(m=0;m<n.length;m+=1)i=f[n[m]],l[i.connectorStyleType]=Math.min(l[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x),h[i.connectorStyleType]=Math.max(h[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x);i=c;for(m=2;0<=m;m-=1)n=b.getPalette(m),v=a.getPolyline(n),n=l[m],null!=n&&n<i&&(r.transformPoints(i,d,n,d,!0,this,function(a,
b,c,d){v.addSegment(new primitives.common.MoveSegment(a,b));v.addSegment(new primitives.common.LineSegment(c,d))}),i=n),n=h[m],null!=n&&n>c&&(r.transformPoints(c,d,n,d,!0,this,function(a,b,c,d){v.addSegment(new primitives.common.MoveSegment(a,b));v.addSegment(new primitives.common.LineSegment(c,d))}),c=n);for(m=e;m<=k;m+=1)i=f[m],n=b.getPalette(i.connectorStyleType),v=a.getPolyline(n),i.hasElbow?(r.transform3Points(i.elbowPoint2.x,i.elbowPoint2.y,i.elbowPoint1.x,i.elbowPoint2.y,i.elbowPoint1.x,i.elbowPoint1.y,
!0,this,function(a,b,c,d,f,e){switch(s.elbowType){case 2:v.addSegment(new primitives.common.MoveSegment(a,b));v.addSegment(new primitives.common.LineSegment(f,e));break;case 3:v.addSegment(new primitives.common.MoveSegment(a,b)),v.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}}),r.transformPoints(i.elbowPoint1.x,i.elbowPoint1.y,i.x,i.y,!0,this,function(a,b,c,d){v.addSegment(new primitives.common.LineSegment(c,d))})):r.transformPoints(i.x,d,i.x,i.y,!0,this,function(a,b,c,d){v.addSegment(new primitives.common.MoveSegment(a,
b));v.addSegment(new primitives.common.LineSegment(c,d))}),g&&(j&&4!=i.visibility)&&v.addArrow(s.linesWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})}else q(a,b,c,d,f,!0,j)}function q(a,b,c,d,f,e,g){var j=null,k=f.length,i,h,l,n,j=e?c:f[k-1].x;h=new primitives.common.Point(j,d);for(c=0;c<k;c+=1){l=f[c];i=b.getPalette(l.connectorStyleType);n=a.getPolyline(i);r.transformPoint(j,d,!0,this,function(a,b){n.addSegment(new primitives.common.MoveSegment(a,b))});switch(s.connectorType){case 1:r.transformPoint(l.x,
l.y,!0,this,function(a,b){n.addSegment(new primitives.common.LineSegment(a,b))});break;case 2:i=new primitives.common.Rect(h,l),e?j>i.x?r.transform3Points(i.right(),i.verticalCenter(),i.x,i.verticalCenter(),i.x,i.bottom(),!0,this,function(a,b,c,d,f,e){n.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):r.transform3Points(i.x,i.verticalCenter(),i.right(),i.verticalCenter(),i.right(),i.bottom(),!0,this,function(a,b,c,d,f,e){n.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,
e))}):j>i.x?r.transformPoints(i.x,i.y,i.x,i.bottom(),!0,this,function(a,b,c,d){n.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):r.transformPoints(i.right(),i.y,i.right(),i.bottom(),!0,this,function(a,b,c,d){n.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}g&&4!=l.visibility&&n.addArrow(s.linesWidth,function(b,c){var d;b.mergeTo(a.getPolyline(b.paletteItem));B&&(d=a.getPolyline({fillColor:"#ff0000"}),d.addSegment(new primitives.common.DotSegment(c.x-1,c.y-1,2,2,
...
case 2:var i,h,l=null,m=k.labelOffset,v,p;if(!primitives.common.isNullOrEmpty(e.label)){switch(e.showLabel){case 0:switch(k.showLabels){case 0:switch(g.actualVisibility){case 3:case 2:l=new primitives.common.Label,l.labelType=0,l.weight=g.leftPadding+g.rightPadding}break;case 1:l=new primitives.common.Label,l.labelType=2,l.weight=1E4}break;case 1:l=new primitives.common.Label,l.weight=1E4,l.labelType=2}if(null!=l){l.text=e.label;v=null!=e.labelSize?e.labelSize:k.labelSize;l.labelOrientation=3!=e.labelOrientation?
e.labelOrientation:3!=k.labelOrientation?k.labelOrientation:0;p=0!=e.labelPlacement?e.labelPlacement:0!=k.labelPlacement?k.labelPlacement:1;switch(l.labelOrientation){case 0:i=v.width;h=v.height;break;case 1:case 2:h=v.width,i=v.height}switch(p){case 0:case 1:l.position=new primitives.common.Rect(a+f/2-i/2,d-m-h,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=
2,l.verticalAlignmentType=1}break;case 2:case 11:l.position=new primitives.common.Rect(a+f+m,d-m-h,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=2,l.verticalAlignmentType=2}break;case 3:l.position=new primitives.common.Rect(a+f+m,d+j/2-h/2,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=2}break;case 4:case 12:l.position=new primitives.common.Rect(a+f+m,d+j+m,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=2}break;case 5:l.position=new primitives.common.Rect(a+f/2-i/2,d+j+m,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=1}break;case 6:case 10:l.position=new primitives.common.Rect(a-i-m,d+j+m,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=0}break;case 7:l.position=new primitives.common.Rect(a-
i-m,d+j/2-h/2,i,h);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=0}break;case 8:case 9:switch(l.position=new primitives.common.Rect(a-i-m,d-m-h,i,h),l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=
...
primitives.orgdiagram.BackgroundAnnotationManagerTask=function(a,b,c,d){function e(){var a=new primitives.common.perimeter.Manager,b,c,d,e,i,h,m,A,w,B,D,z,F,C,x;if(!k.isEmpty()&&(m=[],A=[],k.loopLevels(this,function(a){D=B=null;x=l[a];4!=x.actualVisibility&&(m.push(a),F=[],k.loopLevelItems(this,a,function(a){var b=j.node(a);z=n[a];4!=z.actualVisibility&&null!=b&&(null!=D&&g(F,B,D,z),B=D,D=z)}),null!=D&&g(F,B,D,null),A.push(F))}),0<A.length)){w=[];i=[];b=0;for(c=A.length;b<c;b+=1)i=primitives.common.mergeSort([i,
A[b]],null,!0),w.push(i),i=A[b];w.push(primitives.common.mergeSort([A[b-1]],null,!0));i=[];b=0;for(c=w.length;b<c;b+=1){h={};F=w[b];d=0;for(e=F.length;d<e;d+=1)C=F[d],h[C]=d;i.push(h)}d=[];h=C=null;b=0;for(c=m.length;b<c;b+=1)e=m[b],null!=h&&f(d,b-1,i,w,l[C],h,l[h],l[e]),C=h,h=e;null!=h&&f(d,b-1,i,w,l[C],h,l[h],null);a.add(d)}return a}function f(a,b,c,d,f,e,g,i){var l=Math.floor(m.normalItemsInterval/2),w=null!=f?Math.floor(3*(f.shift+f.depth)/7+4*g.shift/7):g.shift-l,B=null!=i?Math.floor(3*(g.shift+
...
7):c.actualPosition.right()+f;a.push(b);a.push(c)}function h(a,b,c,d,f,e,g,j,k,i,h){var l=[],n=primitives.common.perimeter.SegmentItem,F=Math.floor(m.normalItemsInterval/2),j=null!=j?Math.floor(3*j.actualPosition.right()/7+4*k.actualPosition.x/7):k.actualPosition.x-F,k=null!=i?Math.floor(3*k.actualPosition.right()/7+4*i.actualPosition.x/7):k.actualPosition.right()+F;l.push(new n(j,e,j,g));for(i=c[j]+1;i<=c[k];i+=1)l.push(new n(f[i-1],g,f[i],g));l.push(new n(k,g,k,e));for(i=b[k]-1;i>=b[j];i-=1)l.push(new n(d[i+
1],e,d[i],e));a.push(new primitives.common.perimeter.Item(h,l))}var i=null,j,k,l,n,m;return{process:function(){i=null;j=b.getOrgTree();k=c.getTreeLevels();l=d.getTreeLevelsPositions();n=d.getItemsPositions();m=a.getOptions();return!0},getBackgroundManager:function(){null==i&&(i=e());return i}}};primitives.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(c){return a.getConfig(c)||null!=b&&b.getConfig(c)}}};
...
i,h,l;E.loopLevels(this,function(n){var m=t[n];m.shift=0;m.depth=0;m.partnerConnectorOffset=0;m.actualVisibility=4;e=[];l=h=null;E.loopLevelItems(this,n,function(a,b){var c=q[a];m.depth=Math.max(m.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:l=!l?c.actualSize.height:Math.min(l,c.actualSize.height);break;default:h=!h?c.actualSize.height:Math.min(h,c.actualSize.height)}m.actualVisibility=Math.min(m.actualVisibility,c.actualVisibility);c=g.getOrgPartners(b.id);(0<b.partners.length||
0<c.length)&&e.push(new primitives.common.StackSegment(b))});null==h&&(h=m.depth);null!=l&&l>h&&(h=l);switch(K.verticalAlignment){case 0:m.horizontalConnectorsDepth=h/2;break;case 1:m.horizontalConnectorsDepth=m.depth/2;break;case 2:m.horizontalConnectorsDepth=m.depth-h/2}if(0<e.length){a=0;for(b=e.length;a<b;a+=1){j=e[a];n=g.getOrgPartners(j.context.id);k=j.context.partners.slice(0);0===k.length&&k.push(j.context.id);k=k.concat(n);c=0;for(d=k.length;c<d;c+=1)i=q[k[c]],f=i.offset+i.actualSize.width/
...
primitives.orgdiagram.TracePathAnnotationsTask=function(a,b,c,d,e){function f(a,b,c,d,f){var e,i,h,r,s,u,v,y,A,w,B,D={};e=0;for(i=a.length;e<i;e+=1)if(h=a[e],null!=h.items&&0<h.items.length&&(w=h.items.slice(0),s=d.node(w[0]),null!=s&&(1==w.length&&f.loopParents(this,s.id,function(a){c.node(a).isActive&&w.push(a);return f.SKIP}),1<w.length))){h=1;for(r=w.length;h<r;h+=1)if(v=d.node(w[h]),null!=v){A=b.getShortestPath(s.id,v.id,function(a,b,c){return a.getNear(c)});s=1;for(u=A.length;s<u;s+=1)B=b.edge([A[s-
...
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,r,B,D,z,F,C,x,L,E,G,Q={},I,M={},J,P,K,R={},W;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,i){var h,C,F;if(!d&&!i.hasVisibleChildren)return a.SKIP;h=c.node(f);h||(h=t({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},i),c.add(null,f,h));K=P=0;if(null!=
(z=c.indexOf(f)))P=z,K=c.countSiblings(f)-z-1;C=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=t({parentId:f,actualItemType:b.itemType},b);switch(h.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:q(h,e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 8:case 2:g=c.parent(f);if(h.connectorPlacement&2)B=l(c,p.navigationFamily,h),c.add(g.id,
e.id,e,B+1),e.connectorPlacement=6,e.gravity=2;else if(h.connectorPlacement&8)D=n(c,p.navigationFamily,h),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:B=l(c,p.navigationFamily,h);c.add(g.id,e.id,e,B+1);e.connectorPlacement=6;e.gravity=2;break;default:D=n(c,p.navigationFamily,h),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=h.parentId?q(c.node(h.parentId),e):q(h,e,!0);break;case 2:q(h,e)}break;case 4:q(h,
e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 1:null===h.visualAggregatorId&&m(c,h,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&q(h,e);break;case 0:C.push(e);q(h,e);break;case 7:case 6:g=c.parent(f);if(h.connectorPlacement&2)c.add(g.id,e.id,e,P),e.connectorPlacement=6,e.gravity=2;else if(h.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
K),e.connectorPlacement=12,e.gravity=1;else{switch(b.adviserPlacementType){case 2:c.add(g.id,e.id,e,P);e.gravity=2;break;default:c.add(g.id,e.id,e,c.countChildren(g.id)-K),e.gravity=1}switch(e.actualItemType){case 6:e.connectorPlacement=5;break;case 7:e.connectorPlacement=4}}null!=h.parentId?q(c.node(h.parentId),e):q(h,e,!0)}}});switch(h.actualItemType){case 7:case 8:case 6:break;default:W=[],null!=(g=c.parent(f))&&c.loopChildrenRange(this,g.id,P,c.countChildren(g.id)-K,function(b,c){if(c.id==f)W.push(c);
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&W.push(c)}}),1<W.length&&(R[f]=W)}Q[f]=[];M[f]=[];var x=h,r=i.childrenPlacementType,w=Q[f],L=M[f],E,G,I,J,$,Z,ca,Y,fa=4==x.visibility&&0===x.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:G=3;break;case 2:G=2}0===r&&(r=k(a,x)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);E=x;null!==x.visualAggregatorId&&(E=c.node(x.visualAggregatorId));3==r&&3>C.length&&
...
b,c){var d,e,f,j,k=0,i=[],h,n;e=0;for(f=c.length;e<f;e+=1)d=c[e],k=Math.max(k,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];h=g(a,d);j=1;for(n=d;null!=n.visualAggregatorId;)n=a.node(n.visualAggregatorId),n.connectorPlacement=5,j+=1;for(;j<k;)h=m(a,h,!1),j+=1;i.push(g(a,h).id)}n=g(a,b);if(a.hasChildren(n.id)){h=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(h.id);f=l(a,p.navigationFamily,h);j=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;h=t({visibility:4,connectorPlacement:h.connectorPlacement&
10,gravity:j});a.add(e.id,h.id,h,f+1);for(j=1;j<k;)h=m(a,h,!1),h.connectorPlacement=0,j+=1}e=0;for(f=c.length;e<f;e+=1)d=c[e],p.navigationFamily.loopChildren(this,b.id,function(a,c){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;default:b.id!=d.id&&q(d,c)}return p.navigationFamily.SKIP});h=g(a,h);a.moveChildren(n.id,h.id)}h.partners=i}function g(a,b){for(var c=b;null!=c.visualAggregatorId;)c=a.node(c.visualAggregatorId);return c}function h(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,u);break;case 2:a=u;p.layout.forceCenterOnCursor=!1;p.tasks.process("HighlightItemOptionTask",a);p.graphics.end();break;default:null!=p.mouse&&p.mouse.destroy();j(p.layout);p.layout.element.find("."+p.name).remove();var a=p.layout,b=p.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),r=new primitives.common.Rect(e),B=a.element.offset(),D;D=jQuery('<div tabindex="0"></div>');
D.css({position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px",padding:"0px","margin-bottom":"0px","margin-right":"0px","margin-top":-B.top+Math.floor(B.top)+"px","margin-left":-B.left+Math.floor(B.left)+"px"});D.addClass(b);e=jQuery("<div></div>");e.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});e.addClass(b);e.css(r.getCSS());B=jQuery("<div></div>");B.css({position:"absolute",overflow:"hidden",top:"0px",
left:"0px"});B.addClass("placeholder");B.addClass(b);B.css(r.getCSS());r=jQuery("<div></div>");r.css({position:"absolute",overflow:"visible"});r.addClass("calloutplaceholder");r.addClass(b);r.css({top:"0px",left:"0px",width:"0px",height:"0px"});D.append(e);e.append(B);B.append(r);a.element.append(D);a.scrollPanel=D;a.mousePanel=e;a.placeholder=B;a.calloutPlaceholder=r;p.options.enablePanning&&(p.mouse=new primitives.common.Mouse,p.mouse.init(p.layout.element,{name:p.name,onMouseDrag:k,onMouseStop:l,
onMouseCapture:n}));a=p.layout;a.mousePanel.mousemove(function(a){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,b=a.pageY-b.top,d=p.tasks.getTask("CreateTransformTask"),e=p.tasks.getTask("HighlightItemOptionTask");if(!p.mouse||!p.mouse.isStarted())s=!1,e.hasHighlightEnabled()&&(c=d.getTreeItemForMousePosition(c,b),m(a,c))}).click(function(a){if(!p.mouse||!p.mouse.isStarted()){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,e=a.pageY-b.top,f=p.tasks.getTask("CreateTransformTask"),b=p.tasks.getTask("CursorItemOptionTask"),
c=f.getTreeItemForMousePosition(c,e),g;null!==c&&(c=c.id,s||(e=jQuery(a.target),e.hasClass(p.name+"button")||0<e.parent("."+p.name+"button").length?(g=e.hasClass(p.name+"button")?e:e.parent("."+p.name+"button"),g=g.data("buttonname"),g=d(p,null,c,g),q("onButtonClick",a,g)):"selectiontext"!==e.attr("name")&&("checkbox"===e.attr("name")?(b=(p.options.selectedItems||[]).slice(0),g=d(p,null,c,g),q("onSelectionChanging",a,g),e=primitives.common.indexOf(b,c),0<=e?b.splice(e,1):b.push(c),p.options.selectedItems=
b,q("onSelectionChanged",a,g)):(g=d(p,null,c,void 0),q("onMouseClick",a,g),!g.cancel&&b.hasCursorEnabled()&&(t(a,c),p.layout.scrollPanel.focus())))))}s=!1}).dblclick(function(a){var b;b=p.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&!s&&(b=d(p,null,b,void 0),q("onMouseDblClick",a,b));s=!1});a.scrollPanel.keydown(function(a){var b=p.tasks.getTask("HighlightItemTask"),c=p.tasks.getTask("HighlightItemOptionTask"),d=p.tasks.getTask("CursorItemTask"),e=p.tasks.getTask("CursorItemOptionTask"),
f=p.tasks.getTask("AlignDiagramTask"),g=p.tasks.getTask("CreateTransformTask").getTransform(),b=b.getHighlightTreeItem()||d.getCursorTreeItem(),j,d=null,k,i=p.layout;if(null!=b){switch(a.which){case 13:t(a,b);a.preventDefault();i.scrollPanel.focus();break;case 40:d=1;break;case 38:d=0;break;case 37:d=2;break;case 39:d=3}if(null!=d){for(k=!1;!k;){k=!0;d=g.getOrientation(d);switch(d){case 0:j=f.getNextLevelTreeItem(b,!1);break;case 1:j=f.getNextLevelTreeItem(b,!0);break;case 2:j=f.getNextTreeItem(b,
!0);break;case 3:j=f.getNextTreeItem(b,!1)}null!=j&&(a.preventDefault(),c.hasHighlightEnabled()?m(a,j):e.hasCursorEnabled()&&t(a,j))}i.scrollPanel.focus()}}});p.tasks=c(g,h,i);p.graphics=primitives.common.createGraphics(p.options.graphicsType,p.layout.element);p.graphics.debug=u;p.options.actualGraphicsType=p.graphics.graphicsType;f(!0,u)}}function f(a,b){var c;p.layout.forceCenterOnCursor=a;p.tasks.process("OptionsTask",b);p.graphics.end();a&&(c=p.tasks.getTask("CenterOnCursorTask"),c=c.getPlaceholderOffset(),
p.layout.scrollPanel.scrollLeft(c.x),p.layout.scrollPanel.scrollTop(c.y))}function g(){return p.options}function h(){return p.graphics}function i(){return p.layout}function j(a){null!=a.mousePanel&&(a.mousePanel.unbind("mousemove"),a.mousePanel.unbind("click"),a.mousePanel.unbind("dblclick"));null!=a.scrollPanel&&a.scrollPanel.unbind("keydown")}function k(a){var b=new primitives.common.Point(a.pageX,a.pageY),a=-b.x+r.x,b=-b.y+r.y,c=p.layout.scrollPanel;c.css("visibility","hidden");c.scrollLeft(a).scrollTop(b);
c.css("visibility","inherit");return!1}function l(){s=!0}function n(a){var b=p.layout.scrollPanel;r=new primitives.common.Point(b.scrollLeft()+a.pageX,b.scrollTop()+a.pageY);return!0}function m(a,b){var c=!0,e;null!==b?b.id!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,b.id,void 0),q("onHighlightChanging",a,e),p.options.highlightItem=b.id,e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e))):null!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,null,void 0),q("onHighlightChanging",
a,e),p.options.highlightItem=null,e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e)));return c}function t(a,b){var c;b!==p.options.cursorItem&&(c=d(p,p.options.cursorItem,b,void 0),q("onCursorChanging",a,c),p.options.cursorItem=b,c.cancel||(f(!0,u),q("onCursorChanged",a,c)))}function q(a,b,c){a=p.options[a];null!=a&&a(b,c)}var p={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:a,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},
r,s,u=!1;e();return{destroy:function(){j(p.layout);p.layout.element.find("."+p.name).remove();p.tasks=null;p.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(p.options[b]=a[b])},getOptions:g,setOption:function(a,b){return p.options[a]=b},getOption:function(a){return p.options[a]},update:e,getProcessDiagramConfig:function(){return c(g,h,i).getProcessDiagramConfig()}}};
...
g,j={},k=0,i=!0;i;){f={};i=!1;for(g in d)if(d.hasOwnProperty(g)&&!j[g])switch(j[g]=!0,e.call(a,g,y[g],k)){case A:f={};i=!1;break;case w:break;default:b(this,c,g,function(a){j[a]||(i=f[a]=!0)})}d=f;k+=1}}function f(a,b,c){null!=c&&null!=b&&(null!=y[b]&&null!=r[b])&&e(a,r,r[b],c)}function g(a,b,c){null!=c&&null!=b&&(null!=y[b]&&null!=u[b])&&e(a,u,u[b],c)}function h(a,c,d,e,f,g){var j,k,i,h;if(null!=g){c=[];k={};for(j in y)y.hasOwnProperty(j)&&(k[j]=d[j]||0,k[j]||c.push(j));for(h=0;0<c.length;){i=[];
d=0;for(f=c.length;d<f;d+=1){j=c[d];if(g.call(a,j,y[j],h)){i=[];break}h+=1;b(this,e,j,function(a){k[a]-=1;0===k[a]&&i.push(a)})}c=i}}}function i(a,b){h(a,u,v,r,s,b)}function j(a,b){h(a,r,s,u,v,b)}function k(a,b,c,d,e,f,g,j,k){var i=!1,h,l;if(null!=y[a]&&null!=g[a]){i=!0;if(k){k=0;for(h=b.length;k<h;k+=1)if(l=b[k],null==y[l]||null==g[a][l])i=!1}if(i&&(null!=d&&(y[c]=d),null!=y[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},j[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,j[a]+=1);k=0;for(h=b.length;k<
h;k+=1)l=b[k],c!=l&&(null!=g[a][l]&&(delete g[a][l],j[a]-=1),null!=e[l][a]&&(delete e[l][a],f[l]-=1),e[l][c]||(e[l][c]=!0,f[l]+=1),g[c][l]||(g[c][l]=!0,j[c]+=1))}}return i}function l(a,b,c,d){return k(a,b,c,d,u,v,r,s,!0)}function n(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function m(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function t(a){var c=primitives.common.graph(),d,e,f,g,j,k,i,h,l={};for(d in a)a.hasOwnProperty(d)&&
b(this,r,d,function(d){if(!l.hasOwnProperty(d)){l[d]=!0;e=[];b(this,u,d,function(a){e.push(a)});f=0;for(j=e.length;f<j-1;f+=1)if(k=e[f],a.hasOwnProperty(k))for(g=f+1;g<j;g+=1)if(i=e[g],a.hasOwnProperty(i)){h=Math.abs(a[k].children.length-a[i].children.length);var n=c.edge(k,i);null==n&&(n=new m(h),c.addEdge(k,i,n));n.items.push(d);n.weight+=1}}});return c}var q={},p={},r={},s={},u={},v={},y={},A=1,w=2;primitives.common.isObject(a)&&(q=primitives.common.cloneObject(a.roots,!1),p=primitives.common.cloneObject(a.rootsCount,
...
null,d,e=0,f={},k={},i,h={},l={},n,m,p,q,t,r,s;j(this,function(a,b){f.hasOwnProperty(a)||(f[a]={},k[a]=0);f[a][a]=!0;k[a]+=1;i=!0;g(this,b.id,function(b){var c,d;i=!1;f.hasOwnProperty(b)||(f[b]={},k[b]=0);if(!k[b]&&1==v[a])f[b]=f[a],k[b]=k[a];else for(d in c=f[a],c)c.hasOwnProperty(d)&&!f[b][d]&&(f[b][d]=!0,k[b]+=1);return w});i&&(h[a]=!0,e+=1)});q={};for(p in h)if(h.hasOwnProperty(p))for(m in d=f[p],d)d.hasOwnProperty(m)&&(q[m]||(q[m]=[]),q[m].push(p.toString()));for(;0<e;){d=null;for(n in h)if(h.hasOwnProperty(n)&&
(!d||k[n]<d))d=k[n],c=n;if(null!=c){null!=b&&b.call(a,c,y[c]);d=f[c];for(m in d)if(d.hasOwnProperty(m)&&!l[m]){p=q[m];r=0;for(s=p.length;r<s;r+=1)t=p[r],k[t]-=1;l[m]=!0}delete h[c];e-=1}}},hasNodes:function(){return!primitives.common.isEmptyObject(y)},hasCommonChild:function(a){var c=!1,d,e,f,g,j,k,h;d={};g=f=0;for(j=a.length;g<j;g+=1)k=a[g],null!=y[k]&&!d[k]&&(d[k]=!0,f+=1);e={};for(k in d)d.hasOwnProperty(k)&&b(this,r,k,function(a){e[a]=e[a]?e[a]+1:1});for(h in e)if(e.hasOwnProperty(h)&&null!=u[h]&&
...
primitives.common.TaskManager=function(){var a=new primitives.common.family,b=new primitives.common.DependencyManager,c=[];return{addTask:function(b,e,f,g){if(0<c.length)throw"Task Manager is already initialized";a.add(e,b,new primitives.common.TaskInfo(b,e,f,g))},addDependency:function(a,e){if(0<c.length)throw"Task Manager is already initialized";b.register(a,e)},getTask:function(b){return(b=a.node(b))&&b.task},process:function(d,e){var f=!1;0===c.length&&a.loopTopo(this,function(a,d){d.task=b.register(a,
b.resolve(d.dependencies,d.factory)());c.push(d)});e&&console.log("-- process --");for(var g={},h=0,i=c.length;h<i;h+=1){var j=c[h],k=[];if(j.name==d||g.hasOwnProperty(j.name))(f=j.task.process(e))&&a.loopChildren(this,j.name,function(b){g[b]=!0;e&&k.push(b);return a.SKIP}),e&&console.log(h+". "+j.name+(f?" - forces: "+k.toString():""))}},getProcessDiagramConfig:function(){var d=new primitives.famdiagram.Config;0===c.length&&a.loopTopo(this,function(a,d){d.task=b.register(a,b.resolve(d.dependencies,
d.factory)());c.push(d)});for(var e=0,f=c.length;e<f;e+=1){var g=c[e],h=new primitives.famdiagram.ItemConfig;h.id=g.name;h.title=primitives.common.splitCamelCaseName(g.name).join(" ");h.description=g.task.description||"";h.itemTitleColor=g.color;h.parents=[];a.loopParents(this,g.name,function(b){h.parents.push(b);return a.SKIP});d.items.push(h)}return d}}};
