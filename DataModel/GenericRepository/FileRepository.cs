...
namespace DataModel.FileRepository
{
    /// <summary>
    ...
    public class FileRepository<TEntity> where TEntity : class
    {
        ...
        {
            //return Context.filePersonImage.Select(
              //      t => new filePersonImage { name = t.name, stream_id = t.stream_id, path_locator = t.path_locator, parent_path_locator = t.parent_path_locator });
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual TEntity GetByID(object stream_id)
        {
            return DbSet.Find(stream_id); 
        }
        ...
        /// </summary>
        /// <param name="id"></param>
        public virtual void Delete(object stream_id)
        {
            TEntity entityToDelete = DbSet.Find(stream_id);
